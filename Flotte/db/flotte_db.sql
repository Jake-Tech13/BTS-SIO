...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 05 mai 2026 à 21:34
...
INSERT INTO `user` (`id_user`, `raison_sociale`, `nom`, `prenom`, `email`, `mdp`, `tel`, `code_postal`, `ville`, `adresse`, `numero_tva`, `date_creation`) VALUES
(1, NULL, 'admin', NULL, 'admin@mail.com', 'btssio', '0642884639', NULL, NULL, NULL, NULL, '2025-12-09 14:52:12'),
(3, NULL, 'supadmin', '_', 'admin64@mail.com', '$2y$10$/tvc51ckhlYOsUbjFUFen.H6uYoM0s2XLtwmjW24TsqUdQa7wY5wG', NULL, NULL, NULL, NULL, NULL, '2026-03-03 17:37:43');
...
ALTER TABLE `livraison`
  ADD CONSTRAINT `fk_livraison_client` FOREIGN KEY (`id_client`) REFERENCES `user` (`id_user`) ON UPDATE CASCADE,
